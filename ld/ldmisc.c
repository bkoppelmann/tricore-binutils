...
#ifdef HTC_SUPPORT
/* vfinfo is also called by minfo and other functions; in case of fatal
   warnings, this prevents the executable from being generated...  */

static int info_msg_only = 0;
#endif
