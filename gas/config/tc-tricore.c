...
#define BFD_RELOC_TRICORE_PCPREL6 BFD_RELOC_UNUSED+1
#define BFD_RELOC_TRICORE_PCPREL10 BFD_RELOC_UNUSED+2
...
#define GET_RELOC_NAME(code) \
	  ((code <= BFD_RELOC_UNUSED) \
	   ? bfd_get_reloc_code_name (code) \
	   : pcp_internal_reloc_name[code - BFD_RELOC_UNUSED])
...
#define NO_ALTERNATIVE { 0, NULL,       NULL,  NULL }
  ...
  {"add.a-aaa",    1, {{ 1, "add.a",    "aa",  NULL },
		       NO_ALTERNATIVE		    },  TRICORE_RIDER_B_UP},
  ...
  {"lea-a@w",      2, {{14, "sub.a",    "P8",  NULL },
		       {22, "add.a",    "a4",  NULL }}, TRICORE_RIDER_B_UP},
...
md_begin()
{
  ...
  switch (current_isa & bfd_mach_rider_mask)
    {
    case TRICORE_RIDER_A:
      mach = bfd_mach_rider_a;
    ...
    case TRICORE_RIDER_B:  /* Matches also TRICORE_RIDER_D!  */
      mach = bfd_mach_rider_b;
      break;

    case TRICORE_V2:
      mach = bfd_mach_rider_2;
    ...
    default:
      as_fatal (_("Illegal architecture %d"),
      		(current_isa & bfd_mach_rider_mask));
    }
  ...
  pseudo_codes['q'] = "qU123f5v68nk";
  pseudo_codes['w'] = "wU1234f5Fv689nk0qmxrRo";
  pseudo_codes['W'] = "WU123f5v68nkqmx";
  pseudo_codes['M'] = "MU1234f5Fv689nk0qwWmxrRoO";
  pseudo_codes['m'] = "mU123fv";
  pseudo_codes['x'] = "xU123m";
  pseudo_codes['r'] = "rUF4";
  pseudo_codes['R'] = "RU1234f5Fv689mxr";
  pseudo_codes['o'] = "oU1234f5Fv689nk0qwmxrR";
  pseudo_codes['O'] = "OU1234f5Fv689nk0qwWmxrRo";
  pseudo_codes['t'] = "tU1234f5Fv689nk0qwWMmxrRoO";
  pseudo_codes['T'] = "TU1234f5Fv689nk0qwWMmxrRoOt";
  pseudo_codes['U'] = "U";
  pseudo_codes['@'] = "@S&";
  pseudo_codes['&'] = "&";
  pseudo_codes['<'] = "<";
  ...
  if (current_isa == TRICORE_V2)
    {
	 ...
	 the assembler.  Come to think of it, I'm rather against it.  */
      (void) bfd_set_section_alignment (stdoutput, data_section, 1);
      (void) bfd_set_section_alignment (stdoutput, bss_section, 1);
    }
  else
    {
  ...
  switch (c)
    ...
    case 'm':
      if (!strcmp (arg, "tc10")
        ...
        current_isa = (current_isa & ~bfd_mach_rider_mask) | TRICORE_RIDER_A;
      else if (!strcmp (arg, "tc12")
      	       || !strcmp (arg, "rider-b")
      	       || !strcmp (arg, "TriCore:Rider-B"))
        current_isa = (current_isa & ~bfd_mach_rider_mask) | TRICORE_RIDER_B;
      else if (!strcmp (arg, "tc13")
      	       || !strcmp (arg, "rider-d")
      	       || !strcmp (arg, "TriCore:Rider-D"))
        current_isa = (current_isa & ~bfd_mach_rider_mask) | TRICORE_RIDER_D;
      else if (!strcmp (arg, "tc2")
      	       || !strcmp (arg, "rider-2")
      	       || !strcmp (arg, "TriCore:V2"))
        current_isa = (current_isa & ~bfd_mach_rider_mask) | TRICORE_V2;
  ...
  for (i = the_insn.code->insind; i <= the_insn.code->inslast; ++pop, ++i)
    {
      ...
      for (op = 0; op < the_insn.nops; ++op)
        {
	  if (!strchr (pseudo_codes[pop->args[op]], the_insn.ops[op]))
	    break;
...
md_convert_frag (abfd, segment, fragP)
     ...
     register fragS *fragP;
{
  unsigned char *buf = fragP->fr_opcode, bytecode;
...
long
md_pcrel_from_section (fixP, segment)
     fixS *fixP;
     segT segment;
{
