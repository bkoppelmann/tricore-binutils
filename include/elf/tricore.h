...
/* Instruction set architecture Rider-A.  */

#define EF_TRICORE_RIDER_A	0x00000001
#define EF_TRICORE_V1_1		EF_TRICORE_RIDER_A

/* Instruction set architecture Rider-B.  */

#define EF_TRICORE_RIDER_B	0x00000002
#define EF_TRICORE_V1_2		EF_TRICORE_RIDER_B

/* Instruction set architecture Rider-D (treated the same way as Rider-B).  */

#define EF_TRICORE_RIDER_D	EF_TRICORE_RIDER_B
#define EF_TRICORE_V1_3		EF_TRICORE_RIDER_D

/* Instruction set architecture V2.  */

#define EF_TRICORE_V2		0x00000004
